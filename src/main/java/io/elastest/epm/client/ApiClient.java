...
public class ApiClient {
    ...
    if (IS_ANDROID) {
      try {
        ...
        try {
          sdkVersion =
              Integer.parseInt(
                  (String) Class.forName("android.os.Build$VERSION").getField("SDK").get(null));
        } catch (Exception e2) {
        }
      }
    }
  ...
  private String basePath = "http://localhost:8180/v1";
   ...
   * Set base path
   *
   * @param basePath Base path of the URL (e.g https://localhost:8180/v1
  ...
  /**
   * Parse the given datetime string into Date object. When lenientDatetimeFormat is enabled, the
   * following ISO 8601 datetime formats are supported: 2015-08-16T08:20:05Z 2015-8-16T8:20:05Z
   * 2015-08-16T08:20:05+00:00 2015-08-16T08:20:05+0000 2015-08-16T08:20:05.376Z
   * 2015-08-16T08:20:05.376+00:00 2015-08-16T08:20:05.376+00 Note: The 3-digit milli-seconds is
   * optional. Time zone is required and can be in one of these formats: Z (same with +0000) +08:00
   * (same with +0800) -02 (same with -0200) -0200
   *
  ...
  public Date parseDateOrDatetime(String str) {
    if (str == null) return null;
    else if (str.length() <= dateLength) return parseDate(str);
    else return parseDatetime(str);
  }
