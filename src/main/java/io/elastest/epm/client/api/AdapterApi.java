...
public class AdapterApi {
     ...
     */
    public com.squareup.okhttp.Call getAllAdaptersCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getAllAdaptersValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getAllAdaptersAsync(final ApiCallback<List<Adapter>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAllAdaptersValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Adapter>>(){}.getType();
