...
public class RuntimeApi {
    ...
    private com.squareup.okhttp.Call downloadFileFromInstanceCall(String id, FileDownloadBody fileDownloadBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @param fileDownloadBody Contains details of the file to be downloaded from the given Instance (required)
     * @return File
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public File downloadFileFromInstance(String id, FileDownloadBody fileDownloadBody) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<File> downloadFileFromInstanceWithHttpInfo(String id, FileDownloadBody fileDownloadBody) throws ApiException {
        com.squareup.okhttp.Call call = downloadFileFromInstanceValidateBeforeCall(id, fileDownloadBody, null, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Downloads a file from a VDU. (asynchronously)
     * Download a file with the given filepath from the given VDU.
     * @param id ID of VDU (required)
     * @param fileDownloadBody Contains details of the file to be downloaded from the given Instance (required)
     ...
     */
    public com.squareup.okhttp.Call downloadFileFromInstanceAsync(String id, FileDownloadBody fileDownloadBody, final ApiCallback<File> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = downloadFileFromInstanceValidateBeforeCall(id, fileDownloadBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
     ...
     * @param id ID of VDU (required)
     * @param commandExecutionBody Contains command to be executed and a flag if for the completion of the execution should be awaited (required)
     * @return String
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public String executeOnInstance(String id, CommandExecutionBody commandExecutionBody) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> executeOnInstanceWithHttpInfo(String id, CommandExecutionBody commandExecutionBody) throws ApiException {
        com.squareup.okhttp.Call call = executeOnInstanceValidateBeforeCall(id, commandExecutionBody, null, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Executes given command on the given VDU. (asynchronously)
     * Executes the given command on the VDU with the given ID.
     * @param id ID of VDU (required)
     * @param commandExecutionBody Contains command to be executed and a flag if for the completion of the execution should be awaited (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call executeOnInstanceAsync(String id, CommandExecutionBody commandExecutionBody, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = executeOnInstanceValidateBeforeCall(id, commandExecutionBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Starts the given VDU. (asynchronously)
     * Starts the VDU with the given ID.
     * @param id ID of VDU (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call startInstanceAsync(String id, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = startInstanceValidateBeforeCall(id, progressListener, progressRequestListener);
    ...
    /**
     * Stops the given VDU. (asynchronously)
     * Stops the VDU with the given ID.
     * @param id ID of VDU (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call stopInstanceAsync(String id, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = stopInstanceValidateBeforeCall(id, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call uploadFileToInstanceByFileCall(String id, String remotePath, File file, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        Map<String, Object> localVarFormParams = new HashMap<String, Object>();
        if (remotePath != null)
        localVarFormParams.put("remotePath", remotePath);
        if (file != null)
     ...
     * @param file File which has to be uploaded to the Instance. Either this or the hostPath but not both can be provided. (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void uploadFileToInstanceByFile(String id, String remotePath, File file) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> uploadFileToInstanceByFileWithHttpInfo(String id, String remotePath, File file) throws ApiException {
        com.squareup.okhttp.Call call = uploadFileToInstanceByFileValidateBeforeCall(id, remotePath, file, null, null);
        return apiClient.execute(call);
    }

    /**
     * Uploads a file to a VDU. (asynchronously)
     * Uploads a given file to the given filepath to the given VDU.
     * @param id ID of VDU (required)
     * @param remotePath Absolute path where the file should go on the Instance (required)
     * @param file File which has to be uploaded to the Instance. Either this or the hostPath but not both can be provided. (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call uploadFileToInstanceByFileAsync(String id, String remotePath, File file, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = uploadFileToInstanceByFileValidateBeforeCall(id, remotePath, file, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call uploadFileToInstanceByPathValidateBeforeCall(String id, FileUploadBody fileUploadBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling uploadFileToInstanceByPath(Async)");
        }
        
        // verify the required parameter 'fileUploadBody' is set
        if (fileUploadBody == null) {
            throw new ApiException("Missing the required parameter 'fileUploadBody' when calling uploadFileToInstanceByPath(Async)");
        }
        
        
        com.squareup.okhttp.Call call = uploadFileToInstanceByPathCall(id, fileUploadBody, progressListener, progressRequestListener);
        return call;
     ...
     * @param id ID of VDU (required)
     * @param fileUploadBody Contains details of the file with the given path to upload to the Instance (required)
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void uploadFileToInstanceByPath(String id, FileUploadBody fileUploadBody) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> uploadFileToInstanceByPathWithHttpInfo(String id, FileUploadBody fileUploadBody) throws ApiException {
        com.squareup.okhttp.Call call = uploadFileToInstanceByPathValidateBeforeCall(id, fileUploadBody, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call uploadFileToInstanceByPathAsync(String id, FileUploadBody fileUploadBody, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = uploadFileToInstanceByPathValidateBeforeCall(id, fileUploadBody, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
