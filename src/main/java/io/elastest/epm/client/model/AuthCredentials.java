...
public class AuthCredentials {
  ...
  @ApiModelProperty(
    example = "ubuntu",
    required = true,
    value = "This is the user, which the EPM will use when trying to ssh in to the Worker."
  )
  ...
  @ApiModelProperty(
    example = "null",
    value = "This is the Passphrase of the Key provided for connecting to the Worker."
  )
  ...
  @ApiModelProperty(
    example = "null",
    value = "This is the password of the user, which can be left blank if no password is needed."
  )
  ...
  @ApiModelProperty(
    example = "null",
    value = "The ssh port of the worker, where the EPM can reach it."
  )
