...
public class ClusterFromResourceGroup   {
  ...
  **/
   ...
   * @return masterId
  **/
  @ApiModelProperty(example = "null", required = true, value = "The ID of the VDU which will serve as the master node. This should be an ID of a VDU which belongs to the specified Ressource Group.")
