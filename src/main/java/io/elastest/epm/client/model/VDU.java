...
@javax.annotation.Generated(
  ...
  date = "2018-10-09T12:26:11.755+02:00"
)
public class VDU {
  ...
  @ApiModelProperty(
    required = true,
    value = "The identifier of the deployed VDU in the virtualization technology."
  )
  ...
  @ApiModelProperty(
    example = "testImage1",
    required = true,
    value = "The name of the image used for the VDU."
  )
  ...
  @ApiModelProperty(
    ...
    required = true,
    value = "The name of the network to which the VDU is associated with."
  )
  ...
  public int hashCode() {
    return Objects.hash(
        computeId, events, id, imageName, ip, metadata, name, netName, poPName, status, key);
  }
