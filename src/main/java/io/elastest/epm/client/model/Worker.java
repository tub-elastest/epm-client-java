...
public class Worker   {
  ...
  **/
   ...
   * @return epmIp
  **/
  @ApiModelProperty(example = "null", value = "This is the IP where the EPM is reachable for the Worker. This is needed because the Worker has to be able to reach the EPM for registering adapters.")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", value = "The types which this worker supports at the moment when this information is requested.")
