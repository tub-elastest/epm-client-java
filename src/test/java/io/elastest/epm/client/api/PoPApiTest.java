...
public class PoPApiTest {
   ...
   * Returns all PoPs.
   *
   * <p>Returns all PoPs with all its details.
   *
   ...
   * Returns a PoP.
   *
   * <p>Returns the PoP with the given ID. Returns all its details.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   * Registers a new PoP
   *
   * <p>Registers a new Point-of-Presence represented by a PoP
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   * Unregisters a PoP.
   *
   * <p>Unregisters the PoP that matches with a given ID.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   * Updates a PoP.
   *
   * <p>Updates an already registered PoP.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
