...
public class ResourceGroupApiTest {
   ...
   *
   * <p>Creates a new Resource Group and allocates the defined resources in the defined PoPs.
   *
   ...
   *
   * <p>Deletes the Resource Group that matches with a given ID.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   *
   * <p>Returns all Resource Groups with all details.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   *
   * <p>Returns the Resource Group with the given ID. Returns all its details.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   *
   * <p>Updates an existing ResourceGroup.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
