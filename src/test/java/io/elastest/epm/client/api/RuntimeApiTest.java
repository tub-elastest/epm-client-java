...
public class RuntimeApiTest {
   ...
   *
   * <p>Download a file with the given filepath from the given VDU.
   *
   ...
   *
   * <p>Executes the given command on the VDU with the given ID.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   *
   * <p>Starts the VDU with the given ID.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   * Stops the given VDU.
   *
   * <p>Stops the VDU with the given ID.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   *
   * <p>Uploads a given file to the given filepath to the given VDU.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   * Uploads a file to a VDU.
   *
   * <p>Uploads a given file from the host path to the given file path to the given VDU.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
